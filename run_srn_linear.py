    ...
    with torch.autograd.set_detect_anomaly(True):
        ...
        for epoch in range(start_epoch, opt.max_epoch):
            for model_input, ground_truth in dataloader:
                ...
                print("Iter %07d   Epoch %03d  class_loss %0.4f  KL %0.4f   reg_loss %0.4f" %
                (iter, epoch, class_loss*opt.l1_weight, weighted_kl_loss, reg_loss*opt.reg_weight))
