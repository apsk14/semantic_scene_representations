...
--logging_root /media/data3/apsk14/srn_new_logging/Table/latent_vanilla_single --no_validation \
--stat_root /media/data1/apsk14/srn_seg_data/Table/Table.test \
--obj_name Table \
--checkpoint_path /media/data3/apsk14/srn_new_logging/Table/train_vanilla/checkpoints/epoch_0008_iter_105000.pth \
