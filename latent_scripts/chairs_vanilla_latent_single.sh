...
--data_root /home/apsk14/data/final_data/Chair/Chair.real \
--logging_root /media/data3/apsk14/srn_new_logging/Chair/latent_vanilla_real --no_validation \
--checkpoint_path /media/data3/apsk14/srn_new_logging/Chair/train_vanilla/checkpoints/epoch_0010_iter_105000.pth \
--overwrite_embeddings \
--obj_name Chair \
--img_sidelengths 128 --max_steps_per_img_sidelength 100000 --batch_size_per_img_sidelength 1 \
