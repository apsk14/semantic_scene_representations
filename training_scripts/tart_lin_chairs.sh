...
python ../train_linear_tatarchenko.py \
    --config_filepath "/home/apsk14/srn-segmentation/config_chairs_tart.yml" \
    --model_type linear \
    --specific_observation_idcs 1,2,3 \
    --checkpoint_path /media/data3/apsk14/srn_new_logging/Chair/tart_train/checkpoints/epoch_0025_iter_045000.pth \
    --logging_root /media/data3/apsk14/srn_new_logging/Chair/tart_linear \
    --no_validation \
