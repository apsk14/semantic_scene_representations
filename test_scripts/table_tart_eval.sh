...
python ../test_tatarchenko.py \
    ...
    --tatarchenko_ckpt "/media/data3/apsk14/srn_new_logging/Table/tart_train/checkpoints/epoch_0020_iter_045000.pth" \
    --linear_ckpt "/media/data3/apsk14/srn_new_logging/Table/tart_linear/checkpoints/epoch_5000_iter_005000.pth" \
    --logging_root "/media/data3/apsk14/srn_new_results/Table/table_tatarchenko_linear" \
